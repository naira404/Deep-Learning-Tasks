# Deep Learning & AI Tasks Repository
## Team Collaboration
These Tasks was developed in collaboration with Ftama Alzahraa Abdullah

This repository contains a collection of deep learning and machine learning tasks implemented using Python, PyTorch, TensorFlow, and Keras.  
Each task focuses on a specific concept in Neural Networks, CNNs, NLP, RNNs, Seq2Seq models, Autoencoders, and GANs.
...
- Focus on accuracy optimization and clean notebook structure
...
- Implement:
  - Early Fusion
  - Intermediate Fusion
  - Single modality classification (CT or CXR or Cough)
...
- Applied techniques:
  ...
  - N-grams
  - TF-IDF
- Implementation varies based on team size
